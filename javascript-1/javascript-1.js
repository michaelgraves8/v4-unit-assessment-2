...
darkKnight = console.log(bestMovie('Dark Knight'))
...
//CODE HERE
  let phone1 = new Phone('Apple', 'Iphone 12', 100, 'Black', false)
  
  let phone2 = new Phone('Android', 'Galaxy S21', 100, 'Blue', false)
  
  let phone3 = new Phone('Apple', 'Iphone 4S', 50, 'White', false)
